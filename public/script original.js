...
async function mostraInfomacaoJogador() {
    const idBusca = document.getElementById(2);

    let responseBody = "";

        try {
            const response = await fetch(`http://localhost:3000/obter_informacoes_jogador?id=2`);
